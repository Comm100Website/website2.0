...
// check current row layout
                if( get_row_layout() == '1-column-grey-text-top' ):
                    ...
                    echo '<div class="c-content-box c-size-md 1-column-grey-text-top '.$background_color_class.'">';
                    ...
                    echo '<div class="col-sm-10 col-sm-push-1 c-center" style="margin-top:20px;">';
                     if ($headimage):
