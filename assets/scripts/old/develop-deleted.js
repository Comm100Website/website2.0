...
$(document).ready(function() {
  ...
  if($("#00Nj000000Bz2Xp").length){
	...
	if (document.location.href.toLowerCase().indexOf('thankyouforcallback') > 0) {
	    ...
	    function showInServiceCountry() {
	        ...
	        var FirstName = customerInfo_JSON.FirstName;
	        var LastName = customerInfo_JSON.LastName;
	        var Email = customerInfo_JSON.Email;
	        var Phone = customerInfo_JSON.Phone;
	        var url = 'https://calendly.com/jonathan-89/15-minute-introduction/'
